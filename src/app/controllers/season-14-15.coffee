app.controller 'Season1415Ctrl', ($scope) ->
  ...
  # Load data
  queue()
  .defer d3.csv, '../data/2014-2015/premier-league-teams.csv'
  .defer d3.csv, '../data/2014-2015/premier-league-goals-chances.csv'
  .defer d3.csv, '../data/2014-2015/la-liga-teams.csv'
  .defer d3.csv, '../data/2014-2015/la-liga-goals-chances.csv'
  .defer d3.csv, '../data/2014-2015/bundesliga-teams.csv'
  .defer d3.csv, '../data/2014-2015/bundesliga-results.csv'
  .defer d3.csv, '../data/2014-2015/serie-a-teams.csv'
  .defer d3.csv, '../data/2014-2015/serie-a-results.csv'
  .defer d3.csv, '../data/2014-2015/ligue-one-teams.csv'
  .defer d3.csv, '../data/2014-2015/ligue-one-results.csv'
  .awaitAll parseData
